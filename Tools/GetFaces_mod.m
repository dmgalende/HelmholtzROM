function [intFaces,elemIntfaceInfo,extFaces] = GetFaces_mod(T)
%
...
case 3, %triangle
    Efaces = [1 2; 2 3; 3 1];
case 4, %tetrahedra
    error('Tetrahedra not implemented yet');
end

elemIntfaceInfo = zeros(nElem,3);
index = 1;
intF = 1;
extF = 1;
for iElem=1:nElem
